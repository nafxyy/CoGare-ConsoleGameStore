<div class="w-[400px] bg-slate-800 ">
    <div class="fixed flex flex-col h-screen">
        ...
        <div>
            ...
            <a href="{{ route('admin.console') }}" class="items-center p-5 flex text-white mx-8 mt-5 hover:bg-slate-900 rounded-md">
            ...
            <a href="{{ route('admin.game') }}" class="items-center p-5 flex text-white mx-8 mt-5 hover:bg-slate-900 rounded-md">
