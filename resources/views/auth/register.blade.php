...
@section('content')
    <div class="flex bg-slate-800">
        ...
        <div class="flex flex-col w-full h-screen px-[10%] pt-[2%]">
            ...
            <form action="{{ route('register.action') }}" method="POST" class="pt-[2%]  flex flex-col">
                @csrf
                @if(session('success'))
                ...
                <input type="text" name="nama_asli" placeholder="Enter your full name"
                    class="py-[1%] pl-[2%] rounded-sm w-[60%] focus:outline-none focus:ring ring-slate-900">
                ...
                <input type="file" name="foto_profil"
                    class="py-[1%] rounded-sm w-[60%] focus:outline-none focus:ring ring-slate-900">
                <a href="#" class="text-lime-200 py-[2%] hover:font-semibold">Forgot Password?</a>
                <button type="submit" class="w-[60%] bg-cyan-800 rounded-sm">
