                        ...
                        <tbody>
                            ...
                            @foreach ($game as $g)
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="px-6 py-4">
                                        <img src="{{asset('assets/images/games/'.$g->gambar)}}" alt="" class="w-full">
                                    </td>
                                    <td class="px-6 py-4">
                                        {{ $g->console->nama }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class=" flex w-full h-auto">
                                            ...
                                            <form action="{{route('game.delete', $g->id)}}" method="POST">
                                                @csrf
                                                <button type="submit" onclick="return confirm('Yakin Ingin Hapus {{$g->judul}} ?')"
