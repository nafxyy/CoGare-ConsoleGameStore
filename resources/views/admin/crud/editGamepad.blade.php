...
@section('content')
    <div class="bg-slate-900 flex justify-center items-center pt-[100px] pb-[50px]">
        <div class="w-8/12 p-16 pt-12 pb-12 rounded-xl bg-white text-center divide-y-2 flex flex-col">
            ...
            <form action="{{ route('produk.update', $produk->id) }}" method="post" enctype="multipart/form-data" class="pt-8 w-full md:pl-8">
                @csrf
                <div class="w-full relative">
                    ...
                    <input type="text" name="id_produk" placeholder="ID Produk..." value="{{$produk->id_produk}}"
                ...
                <div class="w-full relative mt-6">
                    ...
                    <input type="file" name="gambar" accept="image/*" value="{{$produk->gambar}}"
                        class="w-full ps-12 pe-4 py-2 bg-slate-50 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-blue-500">
                </div>
                <div class="w-full relative mt-6">
                    <select type="text" name="jenis" class="w-full ps-12 pe-4 py-2 bg-slate-50 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-blue-500">
                        <option value="" disabled selected>Jenis Produk...</option>
                        <option value="console" selected>Console</option>
                        <option value="gamepad" selected>Gamepad</option>
                ...
                <div class="w-full relative mt-6">
                    ...
                    <input type="text" name="platform" placeholder="Platform..." value="{{$produk->platform}}"
                        class="w-full ps-12 pe-4 py-2 bg-slate-50 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-blue-500">
                </div>
                {{-- <script>
