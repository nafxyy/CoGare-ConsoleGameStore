                                ...
                                <tbody>
                                    @foreach ($console as $csl)
                                        <tr class="bg-white border-b">
                                            ...
                                            <td class="px-6 py-4">
                                                <img src="{{asset('assets/images/console/'.$csl->gambar)}}" alt="" class="w-full">
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class=" flex w-full h-auto">
                                                    <a href="{{ route('console.edit', $csl->id) }}">
                                                    ...
                                                    <form action="{{route('console.delete', $csl->id)}}" method="POST">
                                                        @csrf
                                                        <button type="submit" onclick="return confirm('Yakin Ingin Hapus {{$csl->nama}} ?')"
