        ...
        <div class="w-full">
            ...
            <div class="bg-gray-100 h-screen">
                <div class="w-full flex flex-col items-center justify-center z-0 px-4 pt-[15%]">
                    ...
                    <h1 class="text-xl font-normal text-center mb-8 text-blue-500">GAGAL INPUT PRODUK</h1>
                    <h1 class="text-4xl font-bold text-center mb-8 text-black">Stok Item Habis!</h1>
                    <div></div>
                    <h2 class="font-bold text-base text-center mb-8 text-black">Mohon maaf ges stok barangnya abis :)</h2>
